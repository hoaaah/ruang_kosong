...
/**
 * This is the model class for table "r_jurusan".
 *
 * The followings are the available columns in table 'r_jurusan':
 * @property integer $id
...
class Jurusan extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('kampus_id', 'numerical', 'integerOnly'=>true),
			array('name', 'length', 'max'=>50),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, kampus_id, name', 'safe', 'on'=>'search'),
		);
	}
