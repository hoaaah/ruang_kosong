...
class LoginForm extends CFormModel
{
	...
	public function authenticate($attribute,$params)
	{
		if(!$this->hasErrors())
		{
			...
			if(!$this->_identity->authenticate() || User::model()->findAll('username=:username', array(':username' => $this->username))['0']['peran'] > 2)
				$this->addError('password','Username/Password anda salah.');
		}
	}
