...
$gridColumns = array(
	...
	//array('name'=>'name', 'header'=>'Gd'),
        array('name'=>'name', 'header'=>'Gedung', 'type' => 'raw',  'value' =>'CHtml::link($data["name"],Yii::app()->createUrl("Building/view", array("id"=>$data["id"])))', 'htmlOptions'=>array('nowrap' =>'nowrap')),    
	//array('name'=>'alias', 'header'=>'Alias'),
        array('name'=>'alias', 'header'=>'Alias', 'type' => 'raw',  'value' =>'CHtml::link($data["alias"],Yii::app()->createUrl("Building/view", array("id"=>$data["id"])))', 'htmlOptions'=>array('nowrap' =>'nowrap')),    
        array('name'=>'Fasilitas', 'header'=>'Fasilitas', 'value' => ''),
        array('name'=>'action', 'header'=>'List', 'type' => 'raw',  'value' =>'CHtml::link(CHtml::button("Ruang pd ".$data["name"], array("class" => "btn btn-xs btn-info","link" =>Yii::app()->createUrl("Kelas/list", array("id"=>$data["id"])))),Yii::app()->createUrl("Kelas/list", array("id"=>$data["id"])))', 'htmlOptions'=>array('nowrap' =>'nowrap'/*, 'onclick' =>"return confirm('Anda yakin?');"*/)),	
 /*       array(
  ...
  */
	array(
		...
		'class'=>'booster.widgets.TbButtonColumn',
                'header' => 'Aksi',
		'viewButtonUrl'=> 'Yii::app()->createUrl("Building/view", array("id"=>$data["id"]))',
		'updateButtonUrl'=> 'Yii::app()->createUrl("Building/update", array("id"=>$data["id"]))',
		'deleteButtonUrl'=> 'Yii::app()->createUrl("Building/delete", array("id"=>$data["id"]))',
	)
