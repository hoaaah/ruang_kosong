          ...
          <div class="nav-collapse">
			<?php $this->widget('zii.widgets.CMenu',array(
                    ...
                    'items'=>array(
						...
						array('label'=>'Akademik <span class="caret"></span>', 'url'=>'#','itemOptions'=>array('class'=>'dropdown','tabindex'=>"-1"),'linkOptions'=>array('class'=>'dropdown-toggle','data-toggle'=>"dropdown","data-description"=>"Akademik Related"), 
                        'items'=>array(
                            array('label'=>'Prodi-Jurusan', 'url'=>array('/jurusan/index'/*, 'view'=>'columns'*/)),
							array('label'=>'Mata Kuliah', 'url'=>array('/MataKuliah/')),
							//array('label'=>'UI Elements', 'url'=>array('/site/page', 'view'=>'elements')),
                        )),
						array('label'=>'Sarpras <span class="caret"></span>', 'url'=>'#','itemOptions'=>array('class'=>'dropdown','tabindex'=>"-1"),'linkOptions'=>array('class'=>'dropdown-toggle','data-toggle'=>"dropdown","data-description"=>"Room-Building Related"), 
                        'items'=>array(
                            array('label'=>'Atribut Sarpras', 'url'=>array('/Attribute/'/*, 'view'=>'columns'*/)),
							array('label'=>'Ruang Kelas', 'url'=>array('/Building/')),
							//array('label'=>'UI Elements', 'url'=>array('/site/page', 'view'=>'elements')),
                        )),                          
